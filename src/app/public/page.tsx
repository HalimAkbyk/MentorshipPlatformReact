    ...
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center text-white">
            <div>
              ...
              <div className="text-primary-100 text-sm mt-1">Derece Mentor</div>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-bold">350+</div>
              <div className="text-primary-100 text-sm mt-1">Mutlu Ogrenci</div>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-bold">1000+</div>
              <div className="text-primary-100 text-sm mt-1">Tamamlanan Ders</div>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-bold">4.8</div>
              <div className="text-primary-100 text-sm mt-1">Ortalama Puan</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow border border-gray-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Birebir Danismanlik</h3>
              <p className="text-gray-600 leading-relaxed">
                Derece ogrencileriyle birebir goruserek sinav surecini daha verimli yonet.
              </p>
            </div>
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow border border-gray-100">
              <div className="w-16 h-16 bg-primary-50 rounded-2xl flex items-center justify-center mb-6">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Strateji ve Taktikler</h3>
              <p className="text-gray-600 leading-relaxed">
                Basarili ogrencilerin uyguladigi sinav tekniklerini ogren ve yol haritani olustur.
              </p>
            </div>
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow border border-gray-100">
              <div className="w-16 h-16 bg-primary-50 rounded-2xl flex items-center justify-center mb-6">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Motivasyon ve Rehberlik</h3>
              <p className="text-gray-600 leading-relaxed">
                Sinav stresini yonet, dogru calisma aliskanliklari edin ve hedeflerine emin adimlarla ilerle.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-white rounded-2xl p-8 shadow-sm border border-primary-100">
      ...
      <section className="py-20 bg-gradient-to-r from-primary-600 to-primary-500">
        <div className="container mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Mentor Ol</h2>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="flex items-center gap-3 justify-center text-gray-600">
